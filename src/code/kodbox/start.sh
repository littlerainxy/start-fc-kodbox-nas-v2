...
if [ ! -d /mnt/nas/.kodbox-1.35.031/ ]; then
  ...
  unzip /mnt/nas/kodbox-1.35.031.zip && mv /mnt/nas/kodbox-1.35.031 /mnt/nas/.kodbox-1.35.031 && rm /mnt/nas/kodbox-1.35.031.zip && chmod -R 777 /mnt/nas/.kodbox-1.35.031
fi
